                ...
                <div class="row g-pt-30">
                  ...
                  <div class="col-6 col-sm-7 col-lg-8 g-mb-15">
                    ...
                    <div class="g-mb-30">
                      ...
                      <a class="d-inline-block g-color-gray-dark-v5 g-font-size-13 mb-2" href="#">{{ $product->get_category_name($product->category_id) }}</a> / <a class="d-inline-block g-color-gray-dark-v5 g-font-size-13 mb-2" href=""> {{$product->get_subcategory_name($product->subcategory_id) }}</a>
                      <div class="mb-4">
                        <span class="g-color-black g-font-size-20 mr-2">$75.00</span>
                        <s class="g-color-lightred g-font-weight-500 g-font-size-13">{{ number_format($product->price, 2) }}</s>
                      </div>
